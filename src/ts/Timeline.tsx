...
export default class Timeline extends WidgetBase {
  ...
  public takeScreenshot() {
    ...
    this.toggleLoadingIndicator(true, "Захват сцены");
  ...
  private showScreenshot(before: __esri.Screenshot, after: __esri.Screenshot) {
    ...
    context.putImageData(after.data, x, height / 3 - dirtyY, 0, dirtyY, after.data.width, height / 1); //2на3 и 2на1

    context.font = "bold 50px Helvetica";
    context.fillStyle = "white";
    // context.fillText("Сейчас", 15, height / 2 - 22);
    context.fillText("Мой план", 15, height - 22);

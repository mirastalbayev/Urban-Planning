          ...
          <div class="column-17">
            <div class="card card-wide">
              ...
              <div class="card-content">
                <h4 class="trailer-half">Совместное планирование</h4>
                <p class="font-size--1 trailer-half">
                  <ul>
                    <li>При создании фигур дважды щелкните мышью или нажмите <code>C</code> для завершения.</li>
                    <li>Нажмите <code>Del</code> или <code>Backspace,</code> чтобы удалить выбранный объект.</li>
                    <li>Нажмите <code>Escape,</code> чтобы отменить текущее редактирование.</li>
                  </ul>
                </p>
                <div menu>
                  <button class="menu-item btn"
                    onclick={ () => this.timeline.playIntroAnimation() }>Начать планирование</button>
                  <button class="menu-item btn btn-transparent"
                    onclick={ () => this.timeline.startPlanning() }>Пропустить анимацию</button>
                </div>
              </div>
            </div>
          </div>
